...
;   jr      nz, 10$
    ...
    ld      de, #APP_COLOR_TABLE_O
    ld      bc, #0x0020
    call    LDIRVM
    ld      hl, #(appColorTable + 0x0040)
    ld      de, #APP_COLOR_TABLE_I
    ld      bc, #0x0020
    call    LDIRVM
    ld      hl, #(appColorTable + 0x0060)
    ld      de, #APP_COLOR_TABLE_T
    ld      bc, #0x0020
    call    LDIRVM
    ld      hl, #(appColorTable + 0x0080)
    ld      de, #APP_COLOR_TABLE_L
    ld      bc, #0x0020
    call    LDIRVM
    ld      hl, #(appColorTable + 0x00a0)
    ld      de, #APP_COLOR_TABLE_J
    ld      bc, #0x0020
    call    LDIRVM
    ld      hl, #(appColorTable + 0x00c0)
    ld      de, #APP_COLOR_TABLE_S
    ld      bc, #0x0020
    call    LDIRVM
    ld      hl, #(appColorTable + 0x00e0)
    ld      de, #APP_COLOR_TABLE_Z
    ld      bc, #0x0020
    call    LDIRVM
...
appColorTable:
    ...
    .db     (VDP_COLOR_LIGHT_GREEN  << 4) | VDP_COLOR_BLACK, (VDP_COLOR_LIGHT_GREEN  << 4) | VDP_COLOR_BLACK
    .db     (VDP_COLOR_WHITE        << 4) | VDP_COLOR_BLACK, (VDP_COLOR_WHITE        << 4) | VDP_COLOR_BLACK
    .db     (VDP_COLOR_LIGHT_YELLOW << 4) | VDP_COLOR_BLACK, (VDP_COLOR_CYAN         << 4) | VDP_COLOR_BLACK
    .db     (VDP_COLOR_MAGENTA      << 4) | VDP_COLOR_BLACK, (VDP_COLOR_LIGHT_RED    << 4) | VDP_COLOR_BLACK
...
appDefault:
    ...
    .db     APP_MODE_REVERSE
    .db     APP_FRAME_NULL
    .db     VDP_COLOR_LIGHT_GREEN ; APP_COLOR_NULL
    .db     0 ; APP_SCORE_NULL
    .db     0 ; APP_SCORE_NULL
    .db     0 ; APP_SCORE_NULL
    .db     0 ; APP_SCORE_NULL
